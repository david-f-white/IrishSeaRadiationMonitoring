...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-1084946.297503, 6737941.562284, 148293.318057, 7380238.356628], maxZoom: 27, minZoom: 1
    })
});
...
map.getView().fit([-1084946.297503, 6737941.562284, 148293.318057, 7380238.356628], map.getSize());
