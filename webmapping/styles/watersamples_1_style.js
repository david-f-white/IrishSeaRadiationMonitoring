...
var style_watersamples_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Activity o");
    var labelText = "";
    size = 0;
    ...
    if (value >= 2.550000 && value <= 5698.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 5698.000000 && value <= 19878.710000) {
            style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 2.0 + size,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 19878.710000 && value <= 44620.890000) {
            style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 2.0 + size,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 44620.890000 && value <= 120472.000000) {
            style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 2.0 + size,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 120472.000000 && value <= 204314.000000) {
            style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 2.0 + size,
